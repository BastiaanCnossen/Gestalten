...
\begin{document}
	...
	The main result of this section shows that, under suitable hypotheses, passing to the diagonal drops the level of affineness by precisely one. Part (2) generalizes results of Gaitsgory on 1-affineness \citep{Gaitsgory_1Affineness}, and related results for the general case appeared in Stefanich's thesis \citep{Stefanich_HigherQCoh}.
